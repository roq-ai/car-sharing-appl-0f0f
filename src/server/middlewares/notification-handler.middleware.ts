...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Order Placed.create': {
    roles: ['business-owner', 'admin', 'end-customer'],
    key: 'order_placed',
    tenantPath: [],
    userPath: [],
  },
...
const ownerRoles: string[] = ['end-customer'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['business-owner', 'admin', 'end-customer'];
