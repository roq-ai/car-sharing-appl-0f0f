  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the future of commuting with Car Sharing Application. Empowering you to journey, explore, and connect on your terms."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the future of commuting with Car Sharing Application. Empowering you to journey, explore, and connect on your terms.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="End Customer" type="end-customer" abilities={appConfig.ownerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
